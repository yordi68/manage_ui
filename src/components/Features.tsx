                ...
                <div className='flex flex-col space-y-3 md:space-y-0 md:space-x-6 md:flex-row '>
                    ...
                    <div>
                        ...
                        <p className='text-darkGrayishBlue'>
                            ...
                            done to the smallest of details. Never lose sight of
                ...
                <div className='flex flex-col space-y-3 md:space-y-0 md:space-x-6 md:flex-row '>
                    ...
                    <div>
                        ...
                        <p className='text-darkGrayishBlue'>
                            ...
                            toward company goals. Our customizable dashboard helps you
                            built out the reports you need to keep key stakeholders informed. 
                        </p>
                    </div>
                </div>
